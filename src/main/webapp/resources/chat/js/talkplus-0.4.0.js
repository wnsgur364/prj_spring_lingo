(function(A, y) {
    ...
    function le(n) {
        for (
            var r = new Uint8Array(n), e = new Array(r.length), t = 0; t < r.length; t++
        )
...
`) === 0 ?
    ...
    const Ee =
        ...
        Te = (n = "") => {
            ...
            for (
                let t = 0, s = 0, i, a = 0;
                (i = r.charAt(a++)); ~i && ((s = t % 4 ? s * 64 + i : i), t++ % 4) ?
    ...
    class Ie extends W {
        ...
        async removeChannelMembersAsync({
            channelId: e,
            members: t
        }) {
            return h.New(this.appId).post({
        ...
        async getBannedUsersFromChannelAsync({
            channelId: e,
            lastUserId: t
        }) {
            const s = t ?
        ...
        async banUsersFromChannelAsync({
            channelId: e,
            members: t
        }) {
            return h.New(this.appId).post({
        ...
        async unbanUsersFromChannelAsync({
            channelId: e,
            members: t
        }) {
            return h.New(this.appId).post({
        ...
        async getMutedChannelMembersAsync({
            channelId: e,
            lastUserId: t
        }) {
            const s = t ?
        ...
        async unmuteChannelMembersAsync({
            channelId: e,
            members: t
        }) {
            return h.New(this.appId).post({
        ...
        async getChannelPushNotificationSettingsAsync({
            channelId: e
        }) {
            return h.New(this.appId).get({
                sessionToken: this.getSessionToken(),
        ...
        async getChannelPushNotificationSettings({
            channelId: e
        }, t) {
            return this.wrapWithCallbackLoginRequired(
        ...
        async getMessageReactionsAsync({
            channelId: e,
            messageId: t
        }) {
            return h.New(this.appId).get({
        ...
        async updateChannelPrivateTagAsync({
            channelId: e,
            privateTag: t
        }) {
            return h.New(this.appId).post({
        ...
        async updateChannelPrivateDataAsync({
            channelId: e,
            privateData: t
        }) {
            return h.New(this.appId).post({
        ...
        async updateChannelPrivateData({
            channelId: e,
            privateData: t
        }, s) {
            return this.wrapWithCallbackLoginRequired(
        ...
        async updateChannelMemberInfoAsync({
            channelId: e,
            memberInfo: t
        }) {
            return h.New(this.appId).post({
        ...
        async joinChannelByInvitationCode({
            channelId: e,
            invitationCode: t
        }, s) {
            return this.wrapWithCallbackLoginRequired(
        ...
        async transferChannelOwnershipAsync({
            channelId: e,
            userId: t
        }) {
            return h.New(this.appId).post({
